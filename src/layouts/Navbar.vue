<template>
  <div class="px-4 py-5 mx-auto w-full md:px-24 sticky top-0 z-30 bg-gray-50">
    <div class="relative flex items-center justify-between">
      <a href="/" aria-label="Company" title="Smart Parking" class="inline-flex items-center">

        <span class="mx-auto text-xl font-black leading-none tracking-wide text-gray-900 select-none">Smart<span
            class="text-red-600" data-primary="red-600"> Parking</span></span>
      ...
      <ul class="flex items-center hidden space-x-8 lg:flex">
        ...
        <li>
          <a href="/" aria-label="Our product" title="Our product"
            class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Testimonials</a>
        </li>
        <li>
          <a href="/" aria-label="Product pricing" title="Product pricing"
            class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">Contact</a>
        </li>
        <li>
        ...
        <li v-if="user">
          <button class="flex bg-neutral-100 hover:bg-neutral-200 p-4 font-medium text-black border-b w-full"
        ...
        <li v-if="!user">
          <button
            ...
            aria-label="Sign up" title="Sign up" @click="loginDialog = !loginDialog">
            Login
          </button>
        </li>
        <li v-if="!user">
            ...
            <div class="flex items-center justify-between mb-4">
              <div>
                <a href="/" aria-label="Company" title="Company" class="inline-flex items-center">
                  <span
                    class="mx-auto text-xl font-black leading-none tracking-wide text-gray-900 select-none">Smart<span
                      class="text-red-600" data-primary="red-600"> Parking</span></span>
              ...
              <ul class="space-y-4">
                ...
                <li v-else>
                  <button @click="loginDialog = true"
                    class="bg-blue-100 inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-black transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
